...
SRCS_RENDER = render/render.c render/shading.c render/camera.c render/color.c render/color_ops.c render/antialiasing.c render/pixel.c
SRCS_UTILS = utils/error.c utils/memory.c utils/string_utils.c utils/window_hooks.c
