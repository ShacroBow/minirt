...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/02 18:16:27 by kmashkoo          #+#    #+#             */
/*   Updated: 2026/01/02 18:16:28 by kmashkoo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minirt.h"

static void	lint_cone_extra(char *line, t_scene *scene, size_t count)
{
	size_t	i;
	char	*arg;
	char	*valid_args[7];
	...
	while (i < count)
	{
		...
		check_arg(arg, valid_args, scene, "Cone");
		i++;
	}
}
